 ...
 */
final class Version20231122124934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE staff ADD role_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_426EF392D60322AC ON staff');
        $this->addSql('ALTER TABLE staff DROP role_id');
    }
}
