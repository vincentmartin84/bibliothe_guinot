 ...
 */
final class Version20231212110725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD publicationdate DATE NOT NULL');
        $this->addSql('ALTER TABLE user DROP publicationdate');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP publicationdate');
        $this->addSql('ALTER TABLE user ADD publicationdate DATE NOT NULL');
    }
}
